...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // draw floor as normal, but don't write the floor to the stencil
        // buffer, we only care about the containers. We set its mask to 0x00 to
        // not write to the stencil buffer.
        glStencilMask(0x00);
        // floor
        glBindVertexArray(planeVAO);
