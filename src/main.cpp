...
int main() {
    ...
    glCheckError();
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA16F, FB_WIDTH, FB_HEIGHT, 0, GL_RGBA,
                 GL_FLOAT, NULL);
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_COMPONENT, FB_WIDTH,
                          FB_HEIGHT);
