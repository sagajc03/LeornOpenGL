...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_2D, depthMap);
        // renderQuad();        // glfw: swap buffers and poll IO events (keys
