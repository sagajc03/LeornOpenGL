...
int main() {
    ...
    Shader pbrShader("../shaders/pbr.vs", "../shaders/pbr3.fs");
    Shader equirectangularToCubemapShader(
        "../shaders/cubemap2.vs", "../shaders/equirectangular_to_cubemap.fs");
    Shader irradianceShader("../shaders/cubemap2.vs",
                            "../shaders/irradiance_convolution.fs");
    Shader prefilterShader("../shaders/cubemap2.vs", "../shaders/prefilter.fs");
    Shader brdfShader("../shaders/brdf.vs", "../shaders/brdf.fs");
    Shader backgroundShader("../shaders/background.vs",
    ...
    unsigned int ironAlbedoMap =
        loadTexture("../textures/rusted_iron/albedo.png");
    unsigned int ironNormalMap =
        loadTexture("../textures/rusted_iron/normal.png");
    unsigned int ironMetallicMap =
        loadTexture("../textures/rusted_iron/metallic.png");
    ...
    unsigned int goldRoughnessMap =
        loadTexture("../textures/gold/roughness.png");
    ...
    unsigned int grassMetallicMap =
        loadTexture("../textures/grass/metallic.png");
    unsigned int grassRoughnessMap =
        loadTexture("../textures/grass/roughness.png");
    unsigned int grassAOMap = loadTexture("../textures/grass/ao.png");

    // plastic
    unsigned int plasticAlbedoMap =
        loadTexture("../textures/plastic/albedo.png");
    unsigned int plasticNormalMap =
        loadTexture("../textures/plastic/normal.png");
    unsigned int plasticMetallicMap =
        loadTexture("../textures/plastic/metallic.png");
    unsigned int plasticRoughnessMap =
        loadTexture("../textures/plastic/roughness.png");
    ...
    unsigned int wallRoughnessMap =
        loadTexture("../textures/wall/roughness.png");
    ...
    float *data = stbi_loadf("../textures/hdr/newport_loft.hdr", &width,
    ...
    if (data) {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB16F, width, height, 0, GL_RGB,
                     GL_FLOAT, data); // note to GL_FLOAT to store hdr values
    ...
    // pbr: set up projection and view matrices for captureing data nto the
    // cubemap faces
    // ----------------------------------------------------------------------------------
    glm::mat4 captureProjection =
        glm::perspective(glm::radians(90.0f), 1.0f, 0.1f, 10.0f);
    glm::mat4 captureViews[] = {
        glm::lookAt(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0, 0.0f, 0.0f),
                    glm::vec3(0.0f, -1.0f, 0.0f)),
        glm::lookAt(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(-1.0, 0.0f, 0.0f),
                    glm::vec3(0.0f, -1.0f, 0.0f)),
        glm::lookAt(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0, 1.0f, 0.0f),
                    glm::vec3(0.0f, 0.0f, 1.0f)),
        glm::lookAt(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0, -1.0f, 0.0f),
                    glm::vec3(0.0f, 0.0f, -1.0f)),
        glm::lookAt(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0, 0.0f, 1.0f),
                    glm::vec3(0.0f, -1.0f, 0.0f)),
        glm::lookAt(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0, 0.0f, -1.0f),
                    glm::vec3(0.0f, -1.0f, 0.0f)),
    };

    // pbr: convert HDR equirectangular to cubemap
    // -------------------------------------------
